...
from misc.utils import torch_load
...
class DataLoader():
    ...
    def __init__(self, opt):
        ...
        self.my_resnet.load_state_dict(torch_load('./data/imagenet_weights/'+self.cnn_model+'.pth'))
        self.my_resnet = myResnet(self.my_resnet)
        self.my_resnet = self.my_resnet.to(self.device)
        self.my_resnet.eval()
